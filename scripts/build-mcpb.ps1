...
$OUTPUT = Join-Path $ROOT_DIR "midos.mcpb"

Write-Host "Building MidOS desktop extension..." -ForegroundColor Cyan
...
$tempZip = Join-Path $ROOT_DIR "midos.zip"
...
Write-Host "  - Double-click midos.mcpb"
